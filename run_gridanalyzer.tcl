...
# DX file
set dxfile_ini "2217_10C_CO-new.dx"
...
set opt_filename "2217_10C_ils_opt.pdb"
...
set pathways_filename "2217_10C_ils_optimized_path.pdb"
...
set pruned_grid_filename "2217_10C_ils_pruned_grid.dx"
...
if { $mode == 1 } {
   ...
   global_search_min $ref_coord_list $xOrigen $yOrigen $zOrigen $xdelta $ydelta $zdelta $endgridX $endgridY $endgridZ $radius $outfile
}
