...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#
# Define pathways filename (PDB). 
# This file contains the pathways xyz coordinates as well as energies (except for minima points) 
# for all the pathways found.
...
set label_pair_list [ list {C1 C2} {C2 C3} {C1 C4} {A1 B1} {B1 B2} {B2 B3} {B3 B4} {B3 B5} {B2 B6} {B2 B7} {B1 B8} {B8 B9} {B8 B10} ]
set xyz_pair_list {}
...
set rsmp_n 1153
set cutoff 0.5
set pathways_filename "LMP_all.pdb"
...
for {set i 0} {$i < $n_LMPs} {incr i} {
   ...
   exec cp LMP_all.pdb LMP_${ini_label}-${end_label}.pdb
